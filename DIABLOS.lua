...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./DIABLOS.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S DIABLOS -X kill
screen -S DIABLOS ./DIABLOS
done
]])  
file:close() 
...
sudo_users = {SUDO,1765160742,1596391910,bot_id}
...
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(972295724) then
var = 'مبرمج السورس' 
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif tonumber(user_id) == tonumber(bot_id) then  
...
local DIABLOS_Msg = ''  
if msgs > 100 then 
DIABLOS_Msg = 'تفاعلك زفت' 
elseif msgs > 200 then 
DIABLOS_Msg = 'شويه شدها' 
elseif msgs > 300 then 
DIABLOS_Msg = 'شبه متفاعل ' 
elseif msgs > 600 then 
DIABLOS_Msg = 'عود متفاعل' 
elseif msgs > 1000 then 
DIABLOS_Msg = 'متفاعل كفو' 
elseif msgs > 1500 then 
DIABLOS_Msg = 'متفاعل جدا' 
elseif msgs > 2000 then 
DIABLOS_Msg = 'طاك مال تفاعل'  
elseif msgs > 4000 then 
DIABLOS_Msg = 'مخبل بلتفاعل' 
elseif msgs > 4500 then 
DIABLOS_Msg = 'مدمن تفاعل' 
elseif msgs > 5500 then 
DIABLOS_Msg = 'طاك' 
elseif msgs > 7000 then 
DIABLOS_Msg = 'يطك بالكاع' 
elseif msgs > 9500 then 
DIABLOS_Msg = 'دك تفاعل' 
elseif msgs > 10000000000 then 
DIABLOS_Msg = 'ملك التفاعل'
end 
return DIABLOS_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceDIABLOS(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,DIABLOS_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'• عدد المجموعات الان > { '..#group..' }'..DIABLOSk..''..DIABLOS..'\n*• الان عدد المجموعات الحقيقي > { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'TEM_DIABLOS')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_DIABLOS')..') '
status  = '\n تم ترقيته مطور في البوت'
...
local DIABLOS1_Msg = database:get(bot_id.."DIABLOS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DIABLOS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_DIABLOS')..') \n •'..DIABLOS1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DIABLOS_Msg and not Special(msg) then  
local DIABLOS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DIABLOS_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n•["..DIABLOS_Msg.."] \n") 
else
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/TEM_DIABLOS)}\n•["..DIABLOS_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/TEM_DIABLOS)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:set(bot_id.."DIABLOS:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."DIABLOS:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."DIABLOS:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."DIABLOS:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."DIABLOS:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."DIABLOS:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."DIABLOS:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."DIABLOS:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."DIABLOS:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://mode-dev.tk/Api1/DIABLOSapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@TEM_DIABLOS','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
database:sadd(bot_id.."DIABLOS:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DIABLOS:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."DIABLOS:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."DIABLOS:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DIABLOS:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DIABLOS:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DIABLOS:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DIABLOS:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function keko_tsahke_new(tshake1,tshake2)
if tshake2 and tshake2.first_name_ then 
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."DIABLOS:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DIABLOS:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."DIABLOS:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."DIABLOS:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(tshake_nnn2) == tonumber(tshake_nnn) or tonumber(tshake_nnn2) > tonumber(tshake_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DIABLOS:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "•عزيزي >>["..tshake2.username_.."](https://t.me/"..(tshake2.username_ or "TEM_DIABLOS")..")\n•عليك وضع التوحيد ⪼ {`"..database:get(bot_id.."DIABLOS:teh"..msg.chat_id_).."`} بجانب اسمك\n•عدد المحاولات المتبقيه {"..(tonumber(tshake_nnn) - tonumber(tshake_nnn2)).."}")
end
end
end
end
...
local DIABLOSChengName = database:get(bot_id.."DIABLOS:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DIABLOSChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DIABLOSChengName..']')
database:del(bot_id.."DIABLOS:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DIABLOSChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."DIABLOS:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DIABLOSChengUserName = database:get(bot_id.."DIABLOS:Cheng:UserName"..data.id_)
if not data.username_ then 
if DIABLOSChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DIABLOSChengUserName..']')
database:del(bot_id.."DIABLOS:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DIABLOSChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DIABLOS:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DIABLOSChengPhoto = database:get(bot_id.."DIABLOS:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DIABLOSChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."DIABLOS:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DIABLOSChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DIABLOS:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[  
WELCOME IN SOURCE DIABLOS 
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑️',url="t.me/jokerrap2"},{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑️',url="t.me/eljo_ker_m"}},
  {text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑️',url="t.me/mhzon1"}},{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑️',url="t.me/H_S_A_7"}},
{{text = '𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐂𝐀𝐓𝐈𝐎𝐍', url="t.me/TEM_DIABLOS"}},  
{{text = '️𝐓𝐎 𝐓𝐀𝐋𝐊 𝐓𝐎 𝐔𝐒', url="t.me/JOK_ER_7bot"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DIABLOS_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'DIABLOS_SoUrcE')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DIABLOS_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'DIABLOS_SoUrcE')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_DIABLOS')..') \n*تم فتح السوبر*\n')  
end,nil)   
end
...
if result.id_ == tonumber(972295724) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'TEM_DIABLOS')..')'
...
local UserName = (b.username_ or "TEM_DIABLOS")
...
database:set(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DIABLOS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DIABLOS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"•تم منع الكلمه مع التحذير")  
database:del(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DIABLOS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DIABLOS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DIABLOS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"•ارسل الكلمه الان")  
database:set(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DIABLOS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DIABLOS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DIABLOS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DIABLOS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DIABLOS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DIABLOS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n•قائمة المنع \n *•●○●○●○●•ٴ*\n"
for k,v in pairs(list) do  
local DIABLOS_Msg = database:get(bot_id.."DIABLOS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." > {"..DIABLOS_Msg.."}\n"    
end  
if #list == 0 then  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_DIABLOS')..') \n•تم الامر بنجاح\n')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'TEM_DIABLOS')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'DIABLOS:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'DIABLOS:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديابلو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديابلو')
local DIABLOS_Msg = {
'ۿۧهلا ؏ـمࢪي .',
...
send(msg.chat_id_, msg.id_,'['..DIABLOS_Msg[math.random(#DIABLOS_Msg)]..']') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديابلو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'DIABLOS')..') '
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/TEM_DIABLOS) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
DIABLOSdx(msg.chat_id_, msg.id_, '• ايدي المجموعة > ( '..msg.chat_id_..' )\n عدد الادمنيه > ( *'..data.administrator_count_..' )*\n• عدد المحظورين > ( *'..data.kicked_count_..' )*\n• عدد الاعضاء > ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
database:del(bot_id..'DIABLOS:Tr'..msg.chat_id_)
KlamDIABLOS = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
name = KlamDIABLOS[math.random(#KlamDIABLOS)]
database:set(bot_id..'Klam:DIABLOS'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..'Klam:DIABLOS'..msg.chat_id_) or '')..'' and not database:get(bot_id..'DIABLOS:Tr'..msg.chat_id_) then
if not database:get(bot_id..'DIABLOS:Tr'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'•∞ الف مبروك لقد فزت \n•∞ للعب مره اخره ارسل ←{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'DIABLOS:Tr'..msg.chat_id_,true)
end 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [DIABLOS](https://t.me/TEM_DIABLOS)
]]
...
if not database:get(bot_id..'DIABLOS:Reply:Mute'..msg.chat_id_) then
...
database:del(bot_id..'DIABLOS:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•تم تفعيل ردود البوت')
return false
end
if text == 'تعطيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Sre:stats") then
database:set(bot_id..'DIABLOS:Reply:Mute'..msg.chat_id_,true)
...
--------------------------------------------------------------------------------------------------------------
SourceDIABLOS(data.message_,data)
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local DIABLOSAbot = database:get(bot_id.."DIABLOS1:Add:Filter:Rp2"..text..result.chat_id_)   
if DIABLOSAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n•["..DIABLOSAbot.."] \n") 
else
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/TEM_DIABLOS)}\n•["..DIABLOSAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
...
------------------------------------------------------------------------
if text then
local DIABLOS1_Msg = database:get(bot_id.."DIABLOS1:Add:Filter:Rp2"..text..result.chat_id_)   
if DIABLOS1_Msg then    
send(msg.chat_id_, msg.id_,"•"..DIABLOS1_Msg)
